        ...
        <form onSubmit={handleSubmit}>
            <Stack direction={["column", "row"]} spacing="5px" p={10}>
                <FormControl w="300px" id="inputTodo">
                    <Input value={value} onChange={e => setValue(e.target.value)} type="text" placeholder="Add new to do here..." borderColor='purple.500' />
                </FormControl>
                <Button type="submit" leftIcon={<AddIcon />} colorScheme="purple" variant="solid">
                    Add
                </Button>
            </Stack>
        </form>
